	...
	if(defined('TOKEN_WEBSERVICE')){
		...
		if(constant('TOKEN_WEBSERVICE')==$objConfiguracion->obtenerTokenWebservices()){	
			...
			if(!empty($arrayParametrosNoValidos)){
				...
				$objConsultaSQL->addCondicionWhere("reserva.id_zona_comun",
				...
				$objConsultaSQL->addCondicionWhereSecundario("reserva.fecha_hora_inicio",
				" like '". $parametrosRecibidos['inicio_reserva']."%'"," ", clsconstantes::$AND);
