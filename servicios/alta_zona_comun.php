		...
		if(constant('TOKEN_WEBSERVICE')==$objConfiguracion->obtenerTokenWebservices()){	
			...
			if(!empty($arrayParametrosNoValidos)){
				...
				$response['data'] = $api_response_code[ $response['code'] ]['Message'];
					...
					//Creamos el registro
                    $sentenciaInsert =  "insert into zona_comun(id, id_comunidad, tipo, activa, descripcion, imagen, aforo) " .
                    "values (null, '" . $parametrosRecibidos['id_comunidad'] . "', '" . ($parametrosRecibidos['tipo']) . "',
					 '" . $parametrosRecibidos['activa'] . "', '" . $parametrosRecibidos['descripcion'] . "',
					 '" . $parametrosRecibidos['imagen'] . "',
					  '" . $parametrosRecibidos['aforo'] . "');";
